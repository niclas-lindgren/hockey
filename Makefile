...
#
# Usage:
#   make install         Install dependencies via scripts/install.sh
...
.PHONY: help install build-mac build-windows build-linux release desktop-start desktop-clean

help:
	@echo "RVV Miniputt build targets:"
	@echo "  make install         Install dependencies     (delegates to scripts/install.sh)"

...
- [92] [ ] Regenerate or refresh exported HTML artifacts after report-page UI fixes so `season_plan_report.html` no longer contains stale schedule filters/count bar in the latest export folder.

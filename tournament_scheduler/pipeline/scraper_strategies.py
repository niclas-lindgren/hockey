...
STRATEGIES: dict[str, ScraperStrategy] = {
    ...
    "Tønsberg": ScraperStrategy(
        ...
        direct_scraper=True,
        note="Bookup SPA med FullCalendar timeGrid i iframe. Ingen innlogging nodvendig — 'Se tilgjengelighet' viser kalenderen. Handteres av _run_bookup_scraper.",
    ),
    "Sandefjord Penguins": ScraperStrategy(
        ...
        date_param="",
        month_selector=".fc-next-button",
        event_pattern="FullCalendar timeGrid fc-bgevent bookings in iframe (samme som Tønsberg)",
        initial_navigation=[
            {"cmd": "goto", "url": "https://www.bookup.no/Utleie/", "wait_ms": 3000},
            {"cmd": "note", "text": "Søk etter 'Bugårdshallen' eller 'Sandefjord' i søkefeltet"},
            {"cmd": "click", "selector": "text=Bugårdshallen", "wait_ms": 5000},
            {"cmd": "click", "selector": "text=Se tilgjengelighet", "wait_ms": 5000},
        ],
        direct_scraper=False,
        note="Bookup SPA — trenger riktig ID for å bruke /Utleie/Index/<ID>. Nåværende URL bruker hash som er vanskelig for Playwright. LLM-agent kan søke og navigere til riktig objekt, for så å bruke _run_bookup_scraper.",
    ),
    "Jar": ScraperStrategy(

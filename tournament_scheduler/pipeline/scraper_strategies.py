...
STRATEGIES: dict[str, ScraperStrategy] = {
    ...
    "Tønsberg": ScraperStrategy(
        ...
        date_param="",
        month_selector="",
        event_pattern="Bookup booking grid rows with time ranges",
        initial_navigation=[
            {"cmd": "click", "selector": "a:text('Logg inn')", "wait_ms": 2000},
            {"cmd": "type", "selector": "input[type='email'], input[name='email'], #email",
             "text": "${BOOKUP_EMAIL}", "wait_ms": 500},
            {"cmd": "type", "selector": "input[type='password'], input[name='password'], #password",
             "text": "${BOOKUP_PASSWORD}", "wait_ms": 500},

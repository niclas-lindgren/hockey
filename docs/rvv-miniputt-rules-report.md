...
| Arena-intervallkollisjoner | Kjører en hard validering av fullstendige start-/sluttintervaller i samme arena, ikke bare datoantall; 0 tilfelle(r) er registrert i denne planen. | Hard krav |

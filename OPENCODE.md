...
## RVV Miniputt commands in OpenCode
OpenCode does not load Pi extensions directly. In this repo, use the OpenCode project commands under `.opencode/commands/rvv-miniputt/`:
